...
export const ProductCard: React.FC<Props> = ({ product }) => {
  ...
  const link = productId ? `../${itemId}` : `../${category}/${itemId}`;
  ...
  return (
    <li className="ProductCard" data-cy="cardsContainer">
      ...
      >
        ...
        <div className="ProductCard__info">
          <div className="ProductCard__info-item">
            <span className="ProductCard__info-name">Screen</span>
            <span
              className="
          ...
          <div className="ProductCard__info-item">
            <span className="ProductCard__info-name">Capacity</span>
            <span
              className="
                ProductCard__info-name
                ProductCard__info-name--value
      ...
      <Buttons id={itemId} height="40px" width="40px" />
    </li>
  );
};
